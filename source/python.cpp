...
BOOST_PYTHON_MODULE(_pypropagate){
  ...
  /*
  mapped_ndarray<scalar, 1> convert_to_vector(PyObject * Arr){
    init();
    PyArrayObject * converted = (PyArrayObject *)PyArray_FromAny(Arr,PyArray_DescrFromType(py_scalar),1,1,NULL,NULL);
